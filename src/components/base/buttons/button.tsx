...
export const styles = sortCx({
    ...
    colors: {
        /* INTERIOR BAZZAR: the primary action is INK — near-black in light,
           near-white in dark — not the brand. `primary` (brand-filled) is kept
           for the rare action that IS the brand; the panel's default is `ink`. */
        ink: {
            root: [
                "bg-ink-solid text-on-ink shadow-xs-skeuomorphic ring-1 ring-transparent ring-inset hover:bg-ink-solid_hover data-loading:bg-ink-solid_hover",
                "before:absolute before:inset-px before:border before:border-white/12 before:mask-b-from-0%",
                "*:data-icon:text-on-ink/60 hover:*:data-icon:text-on-ink/70",
            ].join(" "),
        },
        primary: {
            root: [
