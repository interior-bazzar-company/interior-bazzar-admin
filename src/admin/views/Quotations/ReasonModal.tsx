/* A one-field guard modal — "why", before an action that needs a reason
   said out loud (reject, cancel). `run` gets the trimmed text; a blank one
   never reaches it. Same header/error/footer shape as Plans' ConfirmModal,
   with a textarea instead of a canned notice. */
