...
import { Button, DateRange, FilterBar, MoreMenu, PageHeader, Segmented, Select, Skeleton, TbTitle, qs } from "../../ui";
      ...
      <FilterBar
        ...
        right={
          <>
            ...
            ) : d.departmentsState === "loading" ? (
              /* Shimmer while the roles load — the control's own size, so the
                 row does not jump when the dropdown arrives. */
              <span role="status" aria-label="Loading departments">
