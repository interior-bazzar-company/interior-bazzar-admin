                        ...
                        <div className={styles.filterRow}>
                            ...
                            <div className={styles.chipsContainer}>
                                {stats?.statusMetrics && Object.keys(stats.statusMetrics).length > 0 ? (() => {
                                    // Use a subtle blue dot as seen in the image for all status chips
                                    ...
                                    <>
                                        <FilterChip label="New" count={0} dotColor="#3b82f6" isActive={filters.leadStatus === "New"} onClick={() => handleFilterClick("leadStatus", "New")} />
                                        ...
                                        <FilterChip label="Deny" count={0} dotColor="#3b82f6" isActive={filters.leadStatus === "Deny"} onClick={() => handleFilterClick("leadStatus", "Deny")} />
                                        <FilterChip label="Rejected" count={0} dotColor="#3b82f6" isActive={filters.leadStatus === "Rejected"} onClick={() => handleFilterClick("leadStatus", "Rejected")} />
                                    </>
                                )}
                            </div>
                        </div>
                        ...
                        <div className={styles.filterRow}>
                            ...
                            <div className={styles.chipsContainer}>
                                {stats?.stageMetrics && Object.keys(stats.stageMetrics).length > 0 ? (() => {
                                    ...
                                    <> 
                                        <FilterChip label="Pending" count={0} dotColor="#3b82f6" isActive={filters.filterStatus === "Pending"} onClick={() => handleFilterClick("filterStatus", "Pending")} />
                                        <FilterChip label="Verified" count={0} dotColor="#3b82f6" isActive={filters.filterStatus === "Verified"} onClick={() => handleFilterClick("filterStatus", "Verified")} />
                                    </>
                                )}
                            </div>
                        </div>
